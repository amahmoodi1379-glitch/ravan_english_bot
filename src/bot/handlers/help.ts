  ...
  },
  {
    ...
    pages: [
      ...
      "توی ⚙️ <b>تنظیمات پروفایل</b> می‌تونی:\n\n" +
        ...
        "✏️ <b>نامِ نمایشی</b>ت رو تغییر بدی (همون اسمی که بقیه توی لیدربورد می‌بینن):\n" +
        "دکمه‌ی ✏️ <b>تغییر نام نمایشی</b> رو بزن، اسمت رو بنویس و بفرست، بعد ✅ <b>تایید</b> کن. همین!\n\n" +
        "🔁 هر چند بار که خواستی می‌تونی اسمت رو عوض کنی — <b>محدودیتی نداره</b> (فقط حداکثر ۳۲ حرف).",
    ],
  },
  {
    key: "medals",
